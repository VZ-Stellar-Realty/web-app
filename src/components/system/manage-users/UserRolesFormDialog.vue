...
const onSubmit = async () => {
  // Debugging: Log formData.pages before submission
  console.log('Submitting form with pages:', formData.value.pages)
...
const onCheckboxChange = async () => {
  await userRolesStore.updateUserRolePages(formData.value.id, formData.value.pages)
}
</script>
